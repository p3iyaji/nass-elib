<div>
    <div class="flex flex-col lg:flex-row justify-between">
        ...
        <div class="w-full lg:w-7/10 p-2 bg-white hover:rounded-md">
            @if ($resources['data'])
                @foreach($resources['data'] as $resource)
                    <div class="flex flex-col sm:flex-row gap-4 p-4 bg-white hover:bg-gray-100 hover:rounded-md">
                        <!-- Image Section -->
                    ...
                    <hr class="space-y-1 border border-gray-200 w-full"/>
                @endforeach
            @else
        ...
        <div class="lg:w-3/10 w-full bg-white p-4" style="width:450px;">
            <div class="mb-6">
                <input type="text" wire:model="searchTerm" id="searchTerm" wire:keydown.enter="searchBooks"
